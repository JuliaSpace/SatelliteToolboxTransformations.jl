...
"""
    compute_δϵ_δψ(eop_iau2000a::EopIau2000A, JD::Number)

Compute the celestial pole offsets in obliquity (`δΔϵ_2000`) and longitude
(`δΔΨ_2000`) [arcsec] given the IERS EOP IAU 2000A `eop_iau2000a`.

This function obtains those values by converting the celestial pole offsets with
respect to the GCRS (`δx` and `δy`). These values are necessary in the
