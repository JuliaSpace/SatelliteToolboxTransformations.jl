...
"""
    r_ecef_to_eci([T,] ECEF, ECI, jd_utc::Number [, eop])
...
selection of the origin and destination frames. Currently, there are two
...
function r_ecef_to_eci(
    ...
    r_ecef_to_eci(DCM, T_ECEF, T_ECI, jd_utc, eop)
end
