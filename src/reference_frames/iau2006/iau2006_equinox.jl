...
export r_mod_to_mj2000_iau2006, r_mj2000_to_mod_iau2006
export r_mj2000_to_gcrf_iau2006, r_gcrf_to_mj2000_iau2006
...
#   - MJ2000: J2000 mean equatorial frame (mean Equator, mean equinox dynamical system).
...
"""
function r_ers_to_mod_iau2006(jd_tt::Number, δΔϵ_2000::Number = 0, δΔΨ_2000::Number = 0)
...
"""
function r_mod_to_ers_iau2006(jd_tt::Number, δΔϵ_2000::Number = 0, δΔΨ_2000::Number = 0)
...
> associated with the ecliptic in the rotational sense, which is perpendicular to the
> angular momentum vector computed from the velocity referred to the rotating orbital plane
> of the Earth-Moon barycenter. (The difference between the two angular momenta is the
> angular momentum associated with the rotation of the orbital plane.)
