...
#
# [4] Capitaine, N., Wallace, P. T (2006). High precision methods for locating the celestial
...
[rad] that are usually obtained from IERS EOP Data (see [`fetch_iers_eop`](@ref) and
[`compute_δΔϵ_δΔψ`](@ref)).
