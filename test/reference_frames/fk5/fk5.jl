...
# == File: ./src/reference_frames/fk5/fk5.jl ===============================================
...
@testset "Functions r_pef_to_tod_fk5 and r_tod_to_pef_fk5" begin
    ...
    q_tod_pef = r_pef_to_tod_fk5(
        Quaternion, JD_UT1, 2453101.828154745, -0.052195 * pi / (180 * 3600)
    )
    ...
    D_pef_tod = r_tod_to_pef_fk5(JD_UT1, 2453101.828154745, -0.052195 * pi / (180 * 3600))
...
@testset "Functions r_tod_to_mod_fk5 and r_mod_to_tod_fk5" begin
    ...
    D_mod_tod = r_tod_to_mod_fk5(
        2453101.828154745, -0.003875 * pi / (180 * 3600), -0.052195 * pi / (180 * 3600)
    )
...
@testset "Functions r_itrf_to_gcrf_fk5 and r_gcrf_to_itrf_fk5" begin
    ...
    q_gcrf_itrf = r_itrf_to_gcrf_fk5(
        Quaternion, JD_UT1, JD_TT, x_p, y_p, δΔϵ_1980, δΔψ_1980
    )
...
#   r_mod = 5094.02901670   i + 6127.87093630   j + 6380.24788850   k [km]
#
# NOTE: The velocity cannot be easily tested because it is necessary to account for the
# Earth rotation when converting from/to PEF.
#
############################################################################################
