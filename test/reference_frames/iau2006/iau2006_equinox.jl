...
# == File: ./src/reference_frames/iau2006/iau2006_equinox.jl ===============================
...
# We are testing all these functions together because we have in [1] the result MOD <=> GCRF
# using equinox-based IAU-2006 theory, but we do not have the intermediate result MOD <=>
# MJ2000.
...
@testset "Functions r_mod_to_mj2000_iau2006, r_mj2000_to_mod_iau2006, r_mj2000_to_gcrf_iau2006, and r_gcrf_to_mj2000_iau2006" begin
    ...
    q_gcrf_mod =
        r_mod_to_mj2000_iau2006(Quaternion, JD_TT) *
    ...
    q_mod_gcrf =
        r_gcrf_to_mj2000_iau2006(Quaternion, JD_TT) *
